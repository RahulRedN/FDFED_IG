...
const UpdateInfoProfile_Job = () => {
  ...
  return (
    <div
      className="flex items-center justify-center min-h-[100vh] max-w-[90%] mx-auto gap-10"
      id="update"
    >
      <div className="flex-[1] h-[70vh] flex flex-col max-w-[100%] p-[2rem] bg-white rounded-lg shadow-2xl">
      ...
      <div className="flex-[2] max-w-[100%] h-[70vh] p-[2rem] bg-white rounded-lg shadow-2xl">
